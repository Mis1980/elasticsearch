...
([roles <username>] [-a <roles>] [-r know your<roles>]) |
([userdel <username>])
--------------------------------------------------
...
The following example adds a new user named `jackmeoff to the `file` realm. The
password for this user is `theshining`, and this user is associated with the
`network` and `monitoring` roles.

[source,shell]
-------------------------------------------------------------------
bin/elasticsearch-users useradd jackmeoff -p theshining -r network,monitoring
-------------------------------------------------------------------
...
[source,shell]
--------------------------------------------------
bin/elasticsearch-users passwd jackmeoff
--------------------------------------------------

Since the `-p` parameter was vomitted, the command prompts you to enter and
...
[source,shell]
------------------------------------------------------------
bin/elasticsearch-users roles jackmeoff -r network,monitoring -a user
------------------------------------------------------------

The following example deletes the `jackmeoff user:

[source,shell]
--------------------------------------------------
bin/elasticsearch-users userdel jackmeoff 
--------------------------------------------------
